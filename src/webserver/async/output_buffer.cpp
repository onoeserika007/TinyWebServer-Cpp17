...
#include "webserver/async/output_buffer.h"
#include <cerrno>
#include <cstring>
#include <string>
...
void OutputBuffer::set_response_with_mmap(const char *response_data, size_t response_len, const std::string &file_path,
